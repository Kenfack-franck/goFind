...
class UtilisateurResourceIT {
    ...
    void putExistingUtilisateur() throws Exception {
        ...
        updatedUtilisateur.name(UPDATED_NAME).email(UPDATED_EMAIL).password(UPDATED_PASSWORD).phoneNumber(UPDATED_PHONE_NUMBER);
    ...
    void partialUpdateUtilisateurWithPatch() throws Exception {
        ...
        partialUpdatedUtilisateur.email(UPDATED_EMAIL).password(UPDATED_PASSWORD);
    ...
    void fullUpdateUtilisateurWithPatch() throws Exception {
        ...
        partialUpdatedUtilisateur.name(UPDATED_NAME).email(UPDATED_EMAIL).password(UPDATED_PASSWORD).phoneNumber(UPDATED_PHONE_NUMBER);
