...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './carpool.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARPOOL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARPOOL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARPOOL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CARPOOL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CARPOOL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CARPOOL actions', async () => {
      const arg = 42666;
