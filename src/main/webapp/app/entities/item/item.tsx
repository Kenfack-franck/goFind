            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gofindApp.item.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="gofindApp.item.name">Name</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                ...
                <th>
                  <Translate contentKey="gofindApp.item.owner">Owner</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {itemList.map((item, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{item.category}</td>
                  <td>{item.status}</td>
                  <td>{item.creationDate ? <TextFormat type="date" value={item.creationDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{item.owner ? <Link to={`/utilisateur/${item.owner.id}`}>{item.owner.id}</Link> : ''}</td>
